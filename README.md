...
3. [步驟 2：資料庫與服務運行模式選擇](#步驟-2資料庫與服務運行模式選擇)
   - [模式 A：本地 Mock 模式 (最快上手)](#模式-a本地-mock-模式-最快上手)
   - [模式 B：本地 Firebase 模擬器模式 (需要 Docker)](#模式-b本地-firebase-模擬器模式-需要-docker)
   - [模式 C：實體 GCP Firebase/Firestore 模式](#模式-c實體-gcp-firebasefirestore-模式)
...
1. **申請 Google Gemini API 金鑰**：
   - 請前往 [Google AI Studio](https://aistudio.google.com/) 申請綁定帳單帳戶的 API Key。
